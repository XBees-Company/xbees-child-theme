...
var Merlin = (function($){
    ...
    function window_loaded(){
        ...
        $( ".merlin__builder--elementor" ).click(function() {
            el_button();
            $(this).addClass( "active" );
            $(".merlin__builder--vc").removeClass( "active" );
            localStorage.setItem('liquid_setup_builder', 'elementor');
        });

        $( ".merlin__builder--vc" ).click(function() {
            vc_button();
            $(this).addClass( "active" );
            $(".merlin__builder--elementor").removeClass( "active" );
